...
namespace PVG.Infrastucture.Domain
{
    ...
    where T : EntityBase<K>
    {
        ...
        Task<T> UpdateValueAsync(T entity, object updateRequest);

        Task<List<T>> UpdateValuesAsync(List<T> entities, List<object> updateRequests);

        Task UpdateAsync(T entity);

        Task UpdateListAsync(IEnumerable<T> entities);

        Task UpdateAddListAsync(IEnumerable<T> entities);
